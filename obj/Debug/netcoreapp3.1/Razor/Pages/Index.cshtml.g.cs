#pragma checksum "C:\Projects\VueTourist\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "99cc660d8c6c50df244f86dc2e651bcda58bde66"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"99cc660d8c6c50df244f86dc2e651bcda58bde66", @"/Pages/Index.cshtml")]
...
<div id=""playfield"">
    <div v-if=""!playerDead"">
        <input onblur=""this.focus()"" autofocus type=""text"" id=""controller"" placeholder=""Focus here to control the green dot..."" maxlength=""1""
               v-on:keydown=""this.value = ''""
               v-on:keydown.left=""playerPosX = playerPosX <= 1 ? 1 : (playerPosX-1); this.value = ''""
    ...
    <div class=""row"" v-for=""ri in 10"" :key=""ri"">
        <div v-bind:class=""{
             ...
             bouncer: ri == bounc");
            WriteLiteral(@"erPosY && bi == bouncerPosX,
...
<script>
    var vm = new Vue({
      ...
      ");
            WriteLiteral(@"          this.playerDead = true;
            },
